...
enum class ELandscapeSplineSegmentSurface : uint8 {
...
enum class EMaterialDepthCompare : uint8 {
...
enum class EMainPassMaterialStencilCompare : uint8 {
	MTSC_Equal = 0,
	MTSC_NotEqual = 1,
	MTSC_Count = 2,
	MTSC_MAX = 3
...
enum class ESkeletalMeshLODGroup : uint8 {
...
enum class EStaticMeshLODGroup : uint8 {
	LevelArchitecture = 0,
	SmallProp = 1,
	LargeProp = 2,
	Deco = 3,
...
struct FPostProcessSettings {
	char bOverride_LDRSaturation : 1; // 0x00(0x01)
	char bOverride_LDRContrast : 1; // 0x00(0x01)
	char bOverride_LDRBrightness : 1; // 0x00(0x01)
	char bOverride_NightfellOpacity : 1; // 0x00(0x01)
	char bOverride_NightfellFadeness : 1; // 0x00(0x01)
	char bOverride_NightfellRadius : 1; // 0x00(0x01)
	char bOverride_NightfellSecondRadius : 1; // 0x00(0x01)
	char bOverride_NightfellLocation : 1; // 0x00(0x01)
	char bOverride_NightfellSecondLocation : 1; // 0x01(0x01)
	char bOverride_WhiteTemp : 1; // 0x01(0x01)
	char bOverride_WhiteTint : 1; // 0x01(0x01)
	char bOverride_ColorSaturation : 1; // 0x01(0x01)
	char bOverride_ColorContrast : 1; // 0x01(0x01)
	char bOverride_ColorGamma : 1; // 0x01(0x01)
	char bOverride_ColorGain : 1; // 0x01(0x01)
	char bOverride_ColorOffset : 1; // 0x01(0x01)
	char bOverride_ColorSaturationShadows : 1; // 0x02(0x01)
	char bOverride_ColorContrastShadows : 1; // 0x02(0x01)
	char bOverride_ColorGammaShadows : 1; // 0x02(0x01)
	char bOverride_ColorGainShadows : 1; // 0x02(0x01)
	char bOverride_ColorOffsetShadows : 1; // 0x02(0x01)
	char bOverride_ColorSaturationMidtones : 1; // 0x02(0x01)
	char bOverride_ColorContrastMidtones : 1; // 0x02(0x01)
	char bOverride_ColorGammaMidtones : 1; // 0x02(0x01)
	char bOverride_ColorGainMidtones : 1; // 0x03(0x01)
	char bOverride_ColorOffsetMidtones : 1; // 0x03(0x01)
	char bOverride_ColorSaturationHighlights : 1; // 0x03(0x01)
	char bOverride_ColorContrastHighlights : 1; // 0x03(0x01)
	char bOverride_ColorGammaHighlights : 1; // 0x03(0x01)
	char bOverride_ColorGainHighlights : 1; // 0x03(0x01)
	char bOverride_ColorOffsetHighlights : 1; // 0x03(0x01)
	char bOverride_ColorCorrectionShadowsMax : 1; // 0x03(0x01)
	char bOverride_ColorCorrectionHighlightsMin : 1; // 0x04(0x01)
	char bOverride_BlueCorrection : 1; // 0x04(0x01)
	char bOverride_ExpandGamut : 1; // 0x04(0x01)
	char bOverride_FilmWhitePoint : 1; // 0x04(0x01)
	char bOverride_FilmSaturation : 1; // 0x04(0x01)
	char bOverride_FilmChannelMixerRed : 1; // 0x04(0x01)
	char bOverride_FilmChannelMixerGreen : 1; // 0x04(0x01)
	char bOverride_FilmChannelMixerBlue : 1; // 0x04(0x01)
	char bOverride_FilmContrast : 1; // 0x05(0x01)
	char bOverride_FilmDynamicRange : 1; // 0x05(0x01)
	char bOverride_FilmHealAmount : 1; // 0x05(0x01)
	char bOverride_FilmToeAmount : 1; // 0x05(0x01)
	char bOverride_FilmShadowTint : 1; // 0x05(0x01)
	char bOverride_FilmShadowTintBlend : 1; // 0x05(0x01)
	char bOverride_FilmShadowTintAmount : 1; // 0x05(0x01)
	char bOverride_FilmSlope : 1; // 0x05(0x01)
	char bOverride_FilmToe : 1; // 0x06(0x01)
	char bOverride_FilmShoulder : 1; // 0x06(0x01)
	char bOverride_FilmBlackClip : 1; // 0x06(0x01)
	char bOverride_FilmWhiteClip : 1; // 0x06(0x01)
	char bOverride_SceneColorTint : 1; // 0x06(0x01)
	...
	char bOverride_AmbientCubemapIntensity : 1; // 0x07(0x01)
	char bOverride_BloomMethod : 1; // 0x07(0x01)
	char bOverride_BloomIntensity : 1; // 0x07(0x01)
	char bOverride_BloomThreshold : 1; // 0x07(0x01)
	char bOverride_Bloom1Tint : 1; // 0x07(0x01)
	char bOverride_Bloom1Size : 1; // 0x07(0x01)
	char bOverride_Bloom2Size : 1; // 0x07(0x01)
	char bOverride_Bloom2Tint : 1; // 0x07(0x01)
	char bOverride_Bloom3Tint : 1; // 0x08(0x01)
	char bOverride_Bloom3Size : 1; // 0x08(0x01)
	char bOverride_Bloom4Tint : 1; // 0x08(0x01)
	char bOverride_Bloom4Size : 1; // 0x08(0x01)
	char bOverride_Bloom5Tint : 1; // 0x08(0x01)
	char bOverride_Bloom5Size : 1; // 0x08(0x01)
	char bOverride_Bloom6Tint : 1; // 0x08(0x01)
	char bOverride_Bloom6Size : 1; // 0x08(0x01)
	char bOverride_BloomSizeScale : 1; // 0x09(0x01)
	char bOverride_BloomConvolutionTexture : 1; // 0x09(0x01)
	char bOverride_BloomConvolutionSize : 1; // 0x09(0x01)
	char bOverride_BloomConvolutionCenterUV : 1; // 0x09(0x01)
	char bOverride_BloomConvolutionPreFilter : 1; // 0x09(0x01)
	...
	char bOverride_BloomConvolutionBufferScale : 1; // 0x0a(0x01)
	char bOverride_BloomDirtMaskIntensity : 1; // 0x0a(0x01)
	char bOverride_BloomDirtMaskTint : 1; // 0x0a(0x01)
	char bOverride_BloomDirtMask : 1; // 0x0a(0x01)
	char bOverride_CameraShutterSpeed : 1; // 0x0a(0x01)
	...
	char bOverride_AutoExposureHighPercent : 1; // 0x0b(0x01)
	char bOverride_AutoExposureMinBrightness : 1; // 0x0b(0x01)
	char bOverride_AutoExposureMaxBrightness : 1; // 0x0b(0x01)
	char bOverride_AutoExposureCalibrationConstant : 1; // 0x0b(0x01)
	...
	char bOverride_AutoExposureMeterMask : 1; // 0x0c(0x01)
	char bOverride_AutoExposureApplyPhysicalCameraExposure : 1; // 0x0c(0x01)
	char bOverride_HistogramLogMin : 1; // 0x0c(0x01)
	char bOverride_HistogramLogMax : 1; // 0x0c(0x01)
	char bOverride_LensFlareIntensity : 1; // 0x0c(0x01)
	...
	float NightfellRadius; // 0x60(0x04)
	float NightfellSecondRadius; // 0x64(0x04)
	float NightfellOpacity; // 0x68(0x04)
	float NightfellFadeness; // 0x6c(0x04)
	...
	struct FVector4 ColorSaturationShadows; // 0xe0(0x10)
	struct FVector4 ColorContrastShadows; // 0xf0(0x10)
	struct FVector4 ColorGammaShadows; // 0x100(0x10)
	struct FVector4 ColorGainShadows; // 0x110(0x10)
	struct FVector4 ColorOffsetShadows; // 0x120(0x10)
	struct FVector4 ColorSaturationMidtones; // 0x130(0x10)
	struct FVector4 ColorContrastMidtones; // 0x140(0x10)
	struct FVector4 ColorGammaMidtones; // 0x150(0x10)
	struct FVector4 ColorGainMidtones; // 0x160(0x10)
	struct FVector4 ColorOffsetMidtones; // 0x170(0x10)
	struct FVector4 ColorSaturationHighlights; // 0x180(0x10)
	struct FVector4 ColorContrastHighlights; // 0x190(0x10)
	struct FVector4 ColorGammaHighlights; // 0x1a0(0x10)
	struct FVector4 ColorGainHighlights; // 0x1b0(0x10)
	struct FVector4 ColorOffsetHighlights; // 0x1c0(0x10)
	float ColorCorrectionHighlightsMin; // 0x1d0(0x04)
	float ColorCorrectionShadowsMax; // 0x1d4(0x04)
	float BlueCorrection; // 0x1d8(0x04)
	float ExpandGamut; // 0x1dc(0x04)
	float FilmSlope; // 0x1e0(0x04)
	float FilmToe; // 0x1e4(0x04)
	float FilmShoulder; // 0x1e8(0x04)
	float FilmBlackClip; // 0x1ec(0x04)
	float FilmWhiteClip; // 0x1f0(0x04)
	struct FLinearColor FilmWhitePoint; // 0x1f4(0x10)
	struct FLinearColor FilmShadowTint; // 0x204(0x10)
	float FilmShadowTintBlend; // 0x214(0x04)
	float FilmShadowTintAmount; // 0x218(0x04)
	float FilmSaturation; // 0x21c(0x04)
	struct FLinearColor FilmChannelMixerRed; // 0x220(0x10)
	struct FLinearColor FilmChannelMixerGreen; // 0x230(0x10)
	struct FLinearColor FilmChannelMixerBlue; // 0x240(0x10)
	float FilmContrast; // 0x250(0x04)
	float FilmToeAmount; // 0x254(0x04)
	float FilmHealAmount; // 0x258(0x04)
	float FilmDynamicRange; // 0x25c(0x04)
	struct FLinearColor SceneColorTint; // 0x260(0x10)
	float SceneFringeIntensity; // 0x270(0x04)
	float ChromaticAberrationStartOffset; // 0x274(0x04)
	float BloomIntensity; // 0x278(0x04)
	float BloomThreshold; // 0x27c(0x04)
	float BloomSizeScale; // 0x280(0x04)
	float Bloom1Size; // 0x284(0x04)
	float Bloom2Size; // 0x288(0x04)
	float Bloom3Size; // 0x28c(0x04)
	float Bloom4Size; // 0x290(0x04)
	float Bloom5Size; // 0x294(0x04)
	float Bloom6Size; // 0x298(0x04)
	struct FLinearColor Bloom1Tint; // 0x29c(0x10)
	struct FLinearColor Bloom2Tint; // 0x2ac(0x10)
	struct FLinearColor Bloom3Tint; // 0x2bc(0x10)
	struct FLinearColor Bloom4Tint; // 0x2cc(0x10)
	struct FLinearColor Bloom5Tint; // 0x2dc(0x10)
	struct FLinearColor Bloom6Tint; // 0x2ec(0x10)
	float BloomConvolutionSize; // 0x2fc(0x04)
	struct UTexture2D* BloomConvolutionTexture; // 0x300(0x08)
	struct FVector2D BloomConvolutionCenterUV; // 0x308(0x08)
	float BloomConvolutionPreFilterMin; // 0x310(0x04)
	float BloomConvolutionPreFilterMax; // 0x314(0x04)
	float BloomConvolutionPreFilterMult; // 0x318(0x04)
	float BloomConvolutionBufferScale; // 0x31c(0x04)
	struct UTexture* BloomDirtMask; // 0x320(0x08)
	float BloomDirtMaskIntensity; // 0x328(0x04)
	struct FLinearColor BloomDirtMaskTint; // 0x32c(0x10)
	struct FLinearColor AmbientCubemapTint; // 0x33c(0x10)
	float AmbientCubemapIntensity; // 0x34c(0x04)
	struct UTextureCube* AmbientCubemap; // 0x350(0x08)
	float CameraShutterSpeed; // 0x358(0x04)
	float CameraISO; // 0x35c(0x04)
	float DepthOfFieldFstop; // 0x360(0x04)
	float DepthOfFieldMinFstop; // 0x364(0x04)
	int32_t DepthOfFieldBladeCount; // 0x368(0x04)
	float AutoExposureBias; // 0x36c(0x04)
	float AutoExposureBiasBackup; // 0x370(0x04)
	char bOverride_AutoExposureBiasBackup : 1; // 0x374(0x01)
	char pad_374_1 : 7; // 0x374(0x01)
	char pad_375[0x3]; // 0x375(0x03)
	char AutoExposureApplyPhysicalCameraExposure : 1; // 0x378(0x01)
	char pad_378_1 : 7; // 0x378(0x01)
	char pad_379[0x7]; // 0x379(0x07)
	struct UCurveFloat* AutoExposureBiasCurve; // 0x380(0x08)
	struct UTexture* AutoExposureMeterMask; // 0x388(0x08)
	float AutoExposureLowPercent; // 0x390(0x04)
	float AutoExposureHighPercent; // 0x394(0x04)
	float AutoExposureMinBrightness; // 0x398(0x04)
	float AutoExposureMaxBrightness; // 0x39c(0x04)
	float AutoExposureSpeedUp; // 0x3a0(0x04)
	float AutoExposureSpeedDown; // 0x3a4(0x04)
	float HistogramLogMin; // 0x3a8(0x04)
	float HistogramLogMax; // 0x3ac(0x04)
	float AutoExposureCalibrationConstant; // 0x3b0(0x04)
	float LensFlareIntensity; // 0x3b4(0x04)
	struct FLinearColor LensFlareTint; // 0x3b8(0x10)
	float LensFlareBokehSize; // 0x3c8(0x04)
	float LensFlareThreshold; // 0x3cc(0x04)
	struct UTexture* LensFlareBokehShape; // 0x3d0(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x3d8(0x80)
	float VignetteIntensity; // 0x458(0x04)
	float GrainJitter; // 0x45c(0x04)
	float GrainIntensity; // 0x460(0x04)
	float AmbientOcclusionIntensity; // 0x464(0x04)
	float AmbientOcclusionStaticFraction; // 0x468(0x04)
	float AmbientOcclusionRadius; // 0x46c(0x04)
	char AmbientOcclusionRadiusInWS : 1; // 0x470(0x01)
	char pad_470_1 : 7; // 0x470(0x01)
	char pad_471[0x3]; // 0x471(0x03)
	float AmbientOcclusionFadeDistance; // 0x474(0x04)
	float AmbientOcclusionFadeRadius; // 0x478(0x04)
	float AmbientOcclusionDistance; // 0x47c(0x04)
	float AmbientOcclusionPower; // 0x480(0x04)
	float AmbientOcclusionBias; // 0x484(0x04)
	float AmbientOcclusionQuality; // 0x488(0x04)
	float AmbientOcclusionMipBlend; // 0x48c(0x04)
	float AmbientOcclusionMipScale; // 0x490(0x04)
	float AmbientOcclusionMipThreshold; // 0x494(0x04)
	char RayTracingAO : 1; // 0x498(0x01)
	char pad_498_1 : 7; // 0x498(0x01)
	char pad_499[0x3]; // 0x499(0x03)
	int32_t RayTracingAOSamplesPerPixel; // 0x49c(0x04)
	struct FLinearColor IndirectLightingColor; // 0x4a0(0x10)
	float IndirectLightingIntensity; // 0x4b0(0x04)
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x4b4(0x01)
	char pad_4B5[0x3]; // 0x4b5(0x03)
	int32_t RayTracingGIMaxBounces; // 0x4b8(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x4bc(0x04)
	float ColorGradingIntensity; // 0x4c0(0x04)
	char pad_4C4[0x4]; // 0x4c4(0x04)
	struct UTexture* ColorGradingLUT; // 0x4c8(0x08)
	float DepthOfFieldSensorWidth; // 0x4d0(0x04)
	float DepthOfFieldFocalDistance; // 0x4d4(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x4d8(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x4dc(0x04)
	float DepthOfFieldFocalRegion; // 0x4e0(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x4e4(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x4e8(0x04)
	float DepthOfFieldScale; // 0x4ec(0x04)
	float DepthOfFieldNearBlurSize; // 0x4f0(0x04)
	float DepthOfFieldFarBlurSize; // 0x4f4(0x04)
	float DepthOfFieldOcclusion; // 0x4f8(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x4fc(0x04)
	float DepthOfFieldVignetteSize; // 0x500(0x04)
	float MotionBlurAmount; // 0x504(0x04)
	float MotionBlurMax; // 0x508(0x04)
	int32_t MotionBlurTargetFPS; // 0x50c(0x04)
	float MotionBlurPerObjectSize; // 0x510(0x04)
	float LPVIntensity; // 0x514(0x04)
	float LPVVplInjectionBias; // 0x518(0x04)
	float LPVSize; // 0x51c(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x520(0x04)
	float LPVSecondaryBounceIntensity; // 0x524(0x04)
	float LPVGeometryVolumeBias; // 0x528(0x04)
	float LPVEmissiveInjectionIntensity; // 0x52c(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x530(0x04)
	float LPVDirectionalOcclusionRadius; // 0x534(0x04)
	float LPVDiffuseOcclusionExponent; // 0x538(0x04)
	float LPVSpecularOcclusionExponent; // 0x53c(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x540(0x04)
	float LPVSpecularOcclusionIntensity; // 0x544(0x04)
	enum class EReflectionsType ReflectionsType; // 0x548(0x01)
	char pad_549[0x3]; // 0x549(0x03)
	float ScreenSpaceReflectionIntensity; // 0x54c(0x04)
	float ScreenSpaceReflectionQuality; // 0x550(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x554(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x558(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x55c(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x560(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x564(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x565(0x01)
	char pad_565_1 : 7; // 0x565(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x566(0x01)
	char pad_567[0x1]; // 0x567(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x568(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x56c(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x570(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x574(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x575(0x01)
	char pad_575_1 : 7; // 0x575(0x01)
	char pad_576[0x2]; // 0x576(0x02)
	int32_t PathTracingMaxBounces; // 0x578(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x57c(0x04)
	float LPVFadeRange; // 0x580(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x584(0x04)
	float ScreenPercentage; // 0x588(0x04)
	char pad_58C[0x4]; // 0x58c(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x590(0x10)
};
...
struct FPoolActorReferencer {
	struct UObject* Referencer; // 0x00(0x08)
...
struct FAnimNotifyEvent : FAnimLinkableElement {
	...
	int32_t NotifyFilterSignificanceLevel; // 0xa0(0x04)
	bool bTriggerOnDedicatedServer; // 0xa4(0x01)
	bool bTriggerOnFollower; // 0xa5(0x01)
...
struct FAnimNode_LinkedAnimLayer : FAnimNode_LinkedAnimGraph {
	...
	bool bEnableDeferredConstructAnimInstance; // 0xb0(0x01)
...
struct FMinimalViewInfo {
	...
	struct FPostProcessSettings PostProcessSettings; // 0x40(0x5a0)
	struct FVector2D OffCenterProjectionOffset; // 0x5e0(0x08)
...
struct FMeshDeviceLODSettings {
	struct FName LODGroupName; // 0x00(0x08)
	int32_t MinLODToLoad; // 0x08(0x04)
};
...
struct FSLDirectionalLightScattering {
	float DirectionalInscatteringExponent_M; // 0x00(0x04)
	float DirectionalInscatteringStartDistance_M; // 0x04(0x04)
	float DirectionalInscatteringMaxDistance_M; // 0x08(0x04)
	struct FLinearColor DirectionalInscatteringColor_M; // 0x0c(0x10)
	float DirectionalInscatteringGamma_M; // 0x1c(0x04)
};

// ScriptStruct Engine.SLHeightFogData
// Size: 0x10 (Inherited: 0x00)
struct FSLHeightFogData {
	float HFogHeight; // 0x00(0x04)
	float HFogHeightFalloff; // 0x04(0x04)
	float HStartDistance; // 0x08(0x04)
	float HMaxFadingDistance; // 0x0c(0x04)
};

// ScriptStruct Engine.SLDistanceFogData
// Size: 0x18 (Inherited: 0x00)
struct FSLDistanceFogData {
	float DFogHeight; // 0x00(0x04)
	float DFogFallOff; // 0x04(0x04)
	float DMaxDistance; // 0x08(0x04)
	float DFogGamma; // 0x0c(0x04)
	float DMaxOpacity; // 0x10(0x04)
	float DStartDistance; // 0x14(0x04)
};
...
struct FLevelSolarDecorationLightMapGUIDArray {
	struct TArray<struct FGuid> MapBuildDataIdArray; // 0x00(0x10)
...
struct FMaterialInstanceBasePropertyOverrides {
	...
	char bOverride_AllowTwosidedFallback : 1; // 0x00(0x01)
	char bAllowTwosidedFallback : 1; // 0x01(0x01)
...
struct FMeshMergingSettings {
	...
	char bUseLandscapeRoadMode : 1; // 0x9e(0x01)
	char bAutoPlacingMergedRoad : 1; // 0x9e(0x01)
	char bIncludeImposters : 1; // 0x9e(0x01)
	char bAllowDistanceField : 1; // 0x9e(0x01)
	char pad_9F[0x1]; // 0x9f(0x01)
	int32_t LandscapeRoadSplitFactor; // 0xa0(0x04)
...
struct FTViewTarget {
	...
	struct APlayerState* PlayerState; // 0x640(0x08)
